...
namespace online
{
    class JoinOnlineGame : OnlineGame
    {
        ...
        {
            hostChar = new Character(G.cm.Load<T2>("roki"),
            ...
            joinChar = new ControllableCharacter(G.cm.Load<T2>("roki"),
        ...
        protected override void SocketThread()
        {
            ...
            while (true)
            {
                base.WriteCharacterData(joinChar);
                base.ReadAndUpdateCharacter(hostChar);
